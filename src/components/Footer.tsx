        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-bold text-xl font-serif">LibraryHub</span>
            </div>
            <p className="text-gray-300 mb-4">
              Your gateway to knowledge and discovery. Explore our vast collection of books and resources.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <span className="text-gray-300">L N MISHRA LIBRARY MUZAFFARPUR</span>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">contact@librarylnm.com</span>
              </div>
              <div>
                <h4 className="font-medium text-amber-300 mb-2">Library Hours:</h4>
